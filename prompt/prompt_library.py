...
# | Key (string)               | Value (prompt variable)         | What It Does                            |
# | -------------------------- | ------------------------------- | --------------------------------------- |
# | `"document_analysis"`      | `document_analysis_prompt`      | Used for extracting metadata from a doc |
# | `"document_comparison"`    | `document_comparison_prompt`    | Used for comparing two documents        |
# | `"contextualize_question"` | `contextualize_question_prompt` | Adds context to a user’s question       |
# | `"context_qa"`             | `context_qa_prompt`             | Does QA from a given document context 